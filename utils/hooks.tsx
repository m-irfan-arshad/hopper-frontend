...
export function useGetCasesHook(dateFilterValue: string, dateSortValue: string, caseFilter: caseFilterInterface[], searchBarValue: string, paginationPage: string) {
    return useQuery(["getCases", dateFilterValue, dateSortValue, caseFilter, searchBarValue, paginationPage], () => fetchCases(dateFilterValue, dateSortValue, caseFilter, searchBarValue, paginationPage))
}
...
const fetchCases = async (dateFilterValue: string, dateSortValue: string, caseFilter: caseFilterInterface[], searchBarValue: string, paginationPage: string) => {
    const url = calculateDashboardURL(dateFilterValue, dateSortValue, caseFilter, searchBarValue, paginationPage);
...
function calculateDashboardURL(dateFilterValue: string, dateSortValue: string, caseFilter: caseFilterInterface[], searchBarValue: string, paginationPage: string) {
    let parameters;
