...
test.describe('Landing Page Features', () => {
    ...
    test('Validating Procedure Date Sorting', async ({ page }) => {
        const dropDownArrow = page.locator(".MuiSvgIcon-root.MuiSvgIcon-fontSizeMedium");
        const procedureDateGroup = await page.locator(".MuiTypography-root.MuiTypography-body1").nth(0).textContent();
        await dropDownArrow.nth(0).click();
        const procedureDate = await page.locator(".MuiTypography-root.MuiTypography-body1").nth(1).textContent();
